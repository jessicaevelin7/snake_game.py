...
#3. Pelin tarkoitus on kolikkoja syömällä kasvattaa matoa, kunnes 
#   kaikki ruudut ovat täyttyneet. Tämän jälkeen peli käynnistyy automaattisesti uudelleen.
 
#4. Mukavia pelihetkiä, toivottavasti toimii! :)
...
#RGB-VÄRIT
LIGHT_PURPLE = (236, 156, 255)
DARK_PURPLE = (87, 17, 128)
PURPLE = (219, 141, 247)
SNAKE_PURPLE = (187, 22, 224)
FONTTI =  "agencyfb"
...
class SnakeGame:
    def __init__(self):
        ...
        self.ruutu_tausta_k.fill(LIGHT_PURPLE)
        ...
        for rivi in range(self.ruutu):
            for sarake in range(self.ruutu):
                ...
                if (rivi+sarake) % 2 == 0:
                    ...
                    pygame.draw.rect(area, LIGHT_PURPLE, kaava)
        ...
        while True:
            for tapahtuma in pygame.event.get():
                if tapahtuma.type == pygame.QUIT:
                    ...
                    if tapahtuma.key == pygame.K_UP and self.mato.suunta != Vector2(0, 1):
                            self.mato.suunta = Vector2(0, -1) 
 
                    if tapahtuma.key == pygame.K_DOWN and self.mato.suunta != Vector2(0, -1):
                        self.mato.suunta = Vector2(0, 1)
 
                    if tapahtuma.key == pygame.K_LEFT and self.mato.suunta != Vector2(1, 0):
                        self.mato.suunta = Vector2(-1, 0) 
                    
                    if tapahtuma.key == pygame.K_RIGHT and self.mato.suunta != Vector2(-1, 0):
                        self.mato.suunta = Vector2(1, 0) 
